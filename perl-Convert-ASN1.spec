...
Version  : 0.29
Release  : 23
URL      : https://cpan.metacpan.org/authors/id/T/TI/TIMLEGGE/Convert-ASN1-0.29.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TIMLEGGE/Convert-ASN1-0.29.tar.gz
...
%prep
%setup -q -n Convert-ASN1-0.29
cd %{_builddir}/Convert-ASN1-0.29
...
cp %{_builddir}/Convert-ASN1-0.29/LICENSE %{buildroot}/usr/share/package-licenses/perl-Convert-ASN1/784ab9036c6150d49f44332e8c2bce01b9013b97
if test -f Makefile.PL; then
